...
% numerical files remain intact, but the main comparison uses two calibrations.
...
long-run equilibria under a finite upper bound on AI productivity. The equilibrium
...
converges to zero. Numerical simulations show that early growth can look
similar in economies that eventually become AI-dominated and those where
labor remains a long-run bottleneck.
%Without an upper bound on AI productivity, complementarity still prevents long-run output-per-person growth from exceeding the exogenous labor-augmenting technological rate.
...
%With substitution and no upper bound on AI productivity, the AI developer's profits become unbounded, leading to a singularity.
\end{abstract}
