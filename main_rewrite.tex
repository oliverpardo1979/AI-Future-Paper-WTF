...
\begin{abstract}
I develop an endogenous-growth model in which a monopolistic AI developer supplies AI services and invests in recursive AI self-improvement. I characterize two long-run equilibrium regimes under an upper bound on AI efficiency. When labor remains a production bottleneck, improvements in AI efficiency can temporarily raise growth, but the growth rates of output per worker and real wages eventually return to the exogenously given rate of labor-augmenting technological progress. When AI and labor are substitutes and attainable AI efficiency is sufficiently high, real wages grow permanently faster. However, output per worker grows even faster, so labor’s income share converges to zero while AI-industry revenue rises as a share of output. Numerical simulations show that output-per-worker growth may remain moderate for a long time before accelerating in the AI-dominated regime or returning to the rate of labor-augmenting technological progress
