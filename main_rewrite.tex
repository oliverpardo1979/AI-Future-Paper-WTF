...
supplies AI production services and uses recursive AI self-improvement to improve AI
efficiency. I characterize the model's
...
converges to zero. With complementarity, long-run output-per-worker growth
cannot exceed the rate of labor-augmenting technological progress, even
without an upper bound on AI efficiency. With substitution, the long-run output-per-worker growth rate increases as AI efficiency increases without bound.
