...
Section~\ref{subsec:rewrite-uncapped-unit-bgp} and establishes local
equilibrium trajectories near its BGP. I use the uncapped research law
\eqref{eq:rewrite-uncapped-unit-law} and the output elasticities
\eqref{eq:rewrite-uncapped-unit-elasticities}.

\subsection{An explicit balanced-growth equilibrium}

At unit elasticity, $s_X=\omega_X$ and $e_X=1-\beta$. The AI-demand and monopoly conditions,
