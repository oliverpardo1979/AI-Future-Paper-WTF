...
The delayed acceleration also connects to \citet{jones2026future}, who
explains how remaining bottleneck tasks can keep aggregate gains modest
before a later takeoff. My simulations produce delayed acceleration without
an expanding set of automated tasks: the developer's research decision and
capital accumulation gradually change the scale and efficiency of AI services.
The qualitative similarity does not identify research productivity or validate
the simulated dates.

The two research-productivity values are illustrative, not estimates of
the current AI economy. No expenditure or price moment is targeted.
...
\citet{korinekmckelvey2026}. Their estimates measure historical US compute
expenditure and AI services, not worldwide autonomous RSI. The simulations
therefore do not jointly fit industry size, research expenditure and price
changes. An observed price decline would not by itself identify research
productivity: hardware improvements and changes in competition can also
