% Preserved high-target subsection; not included in the active manuscript.
...
fixed-productivity pre-RSI BGP of Section~\ref{subsec:rewrite-rsi-activation}:
...
\input{sections_rewrite/preserved/rsi_research_share_high_parameters}
