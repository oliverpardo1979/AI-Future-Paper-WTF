...
This paper endogenizes investment in AI research, which in turn determines the pace of AI improvement. Even when AI research is autonomous, computing requires resources that compete with consumption and accumulation of physical capital. Algorithms and model weights, by contrast, are non-rival: using them does not deplete them. Following \citet{romer1990}, I use monopoly rents to make research investment profitable. In practice, firms compete to develop algorithms and train models. However, as
...
Autonomous AI research is not sufficient for permanently faster
output-per-worker growth, nor does such growth require AI efficiency to
improve forever. Under complementarity, human labor remains a production
bottleneck even without an upper bound on AI efficiency. Conversely, with
sufficient substitution and sufficiently high AI efficiency, capital
accumulation and expanding inference compute can sustain growth above the
exogenous rate of labor-augmenting technological progress even as AI
efficiency approaches a finite limit.

With a finite upper bound on AI efficiency, permanently faster wage growth requires sufficient substitution between AI and labor and sufficiently high attainable efficiency. In this AI-dominated regime, output and AI revenue per worker grow faster than wages, so labor's income share vanishes even as wages rise. AI-dominated growth can permanently increase the net return on physical capital, raising questions about
wealth concentration not examined here \citep{mollrachelrestrepo2022}. When labor remains a production bottleneck, growth in output per worker and wages instead returns to the exogenous rate of labor-augmenting technological progress. The upper bound on AI efficiency matters for these growth and distributional outcomes: without it, the unit-elasticity case can sustain both growth rates above this exogenous rate while preserving a positive labor share. Still, simulations show that early growth can look similar across regimes with different long-run outcomes. The question remains whether human labor will be essential enough for wages to keep pace with the rest of the economy.
