...
Thus the equation
\begin{equation}
 \kappa^\star=\overline B^\theta\mathcal H_\sigma(\overline s_X)
...
solution if and only if $\overline B<B^\dagger(\sigma)$.
...
\begin{align}
 ...
 &\overline k&=\frac{\overline y}{\kappa^\star},\nonumber\\
...
Let $\sigma>1$ and $\overline B>B^\dagger(\sigma)$.
...
\begin{align}
 \overline y&=\overline\kappa(\overline B;\sigma),&
...
stocks. At $\overline B=B^\dagger(\sigma)$ the interior-share terminal
...
$\sigma<1$ and $\overline B\leq B^\dagger(\sigma)$, it does not rule out
