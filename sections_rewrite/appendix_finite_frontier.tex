...
of alternative research policies reachable from the initial productivity.
The upper bound makes this possible for initial productivity sufficiently
...
\par\medskip\noindent\textit{Step 1. Feasible productivity and candidate long-run values.}
...
normalization. Divide capital, consumption, and the AI-productivity shadow
price by effective labor, and multiply the remaining productivity gap by
effective labor:
\begin{equation}
...
AI-productivity gap. The research condition gives
\[
...
shadow value by capital and scale the productivity gap by capital:
\[
...
AI-productivity level in $[B_0,\overline B)$, not just on the selected path.
...
bounds $\varepsilon_{B,t}(b)$ uniformly for these states and for AI-productivity levels near
...
These choices also satisfy the strict productivity restriction in Step 4.
...
\Needspace{4\baselineskip}
\begin{proof}[Proof of the AI-bottleneck statement following Proposition~\ref{prop:rewrite-equilibrium-regimes}]
\phantomsection
...
equation~\eqref{eq:rewrite-frontier-share-map}, established in Step 1 above,
