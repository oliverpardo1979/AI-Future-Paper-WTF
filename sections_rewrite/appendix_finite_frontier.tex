...
and the same construction works for every finite positive frontier.
...
The first three cases of Proposition~\ref{prop:rewrite-equilibrium-regimes}
give $g_w\to\gamma$ and a positive limiting labor share, using
$wL/Y=(1-\alpha)(1-s_X)$.
