...
This subsection proves Propositions~\ref{prop:rewrite-capped-complements-existence}--\ref{prop:rewrite-capped-substitutes-existence}. The headings below identify which parts of the argument prove each proposition.
...
\subsubsection{Common preliminary derivations}
\label{app:rewrite-finite-preliminaries}
...
\subsubsection{Proof of Propositions~\ref{prop:rewrite-capped-complements-existence} and~\ref{prop:rewrite-capped-unit-existence}, and of the labor-bottleneck case of Proposition~\ref{prop:rewrite-capped-substitutes-existence}}
\label{app:rewrite-positive-share-proof}
...
\subsubsection{Proof of the AI-dominated case of Proposition~\ref{prop:rewrite-capped-substitutes-existence}}
\label{app:rewrite-ai-dominated-proof}
...
\subsubsection{Completion of the proofs of Propositions~\ref{prop:rewrite-capped-complements-existence}--\ref{prop:rewrite-capped-substitutes-existence}}
\label{app:rewrite-finite-optimality-proof}
