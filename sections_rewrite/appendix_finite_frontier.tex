...
Household utility is finite under
Assumption~\ref{ass:rewrite-growth-discounting} because $\log(C/N)$ grows at
most linearly and $\rho>n$. Log utility is concave, the household budget is
linear at given prices and distributions, and the Euler and transversality conditions
