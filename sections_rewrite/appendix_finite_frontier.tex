...
capability gap. The research condition gives
\[
...
Positivity of $\tau,d,c,\widetilde q,k$ and the original capability law
...
capability in $[B_0,\overline B)$, not just on the selected path.
...
bounds $\varepsilon_B$ uniformly for these states and for capabilities near
