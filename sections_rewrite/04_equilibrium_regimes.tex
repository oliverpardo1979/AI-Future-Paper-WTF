...
To show this, consider the case where $\sigma>1$ and define $\zeta(B)$ as the value of $Y/K$ when $s_X\to1$ conditional on a level of AI efficiency $B$ : 
\begin{equation}
 \zeta(B)
 =\left[(1-\alpha)^2B\,
