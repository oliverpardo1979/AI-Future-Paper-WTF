...
to raise long-run real wages when capital adjusts and the interest rate
remains fixed. I instead characterize wage growth along equilibrium paths
with an endogenous interest rate: Equation~\eqref{eq:rewrite-substitutes-wage-growth}
shows how the substitution elasticity governs the wage-growth premium.
Rising real wages alongside a vanishing labor share also arise in
\citet{raymookherjee2022}, where capital accumulation drives automation even
