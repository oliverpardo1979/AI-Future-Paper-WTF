\section{Equilibrium with a finite upper bound on AI efficiency}
...
The omission of the case where $\sigma<1$ and $\overline B < \mathcal B(\sigma)$ is deliberate as the upper bound $\overline B$ on AI efficiency is a device to avoid a singularity when $\sigma>1$. In that case AI becomes a bottleneck and long-run output-per-worker grows at a rate lower than $\gamma$.
...
Section~\ref{sec:rewrite-uncapped} studies the economy without an upper bound
on AI efficiency. Those results require a separate equilibrium analysis.
