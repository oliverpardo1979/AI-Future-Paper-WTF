...
Figure~\ref{fig:rewrite-frontier-regimes} shows the threshold on both sides
of unit elasticity. For $0<\sigma<1$, the labeled region above the curve
corresponds to the positive-labor-share equilibria in
Proposition~\ref{prop:rewrite-capped-complements-existence}.
For $\sigma>1$, the curve separates the two constructed growth regimes.
...
construction in Proposition~\ref{prop:rewrite-capped-complements-existence};
the region below that branch is left uncharacterized. For $\sigma>1$,
...
Neither dashed boundary is covered by the existence proof.}
