...
\subsection{Balanced growth without an AI-efficiency frontier}
\label{subsec:rewrite-uncapped-unit-bgp}

I now set $\sigma=1$ and remove the efficiency frontier. The research law is
\begin{equation}
 \dot B=\chi(BM)^\eta.
...
and both transversality conditions. This is a separate equilibrium
construction, not a limit of the finite-frontier equilibria above.
...
\subsection{The role of the frontier beyond unit elasticity}
