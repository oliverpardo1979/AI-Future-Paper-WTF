...
\ref{fig:rewrite-ai-distribution} present the six main outcomes in two groups.
...
scale. Their vertical distance therefore measures the growth wedge in
...
\begin{figure}[H]
 ...
 \caption{Growth and returns. Each panel
 compares the same four admitted numerical equilibrium trajectories over
 4,000 model years. Output-per-capita growth and real-wage growth use the same
 linear percentage scale; net interest uses a separate linear percentage
 scale. All scenarios have the same
...
\begin{figure}[H]
 ...
 output. All three panels use linear scales.}
...
to final output; Figure~\ref{fig:rewrite-technology-revenue} separates its
inference costs, research expenditure, and net distribution to its owner.
