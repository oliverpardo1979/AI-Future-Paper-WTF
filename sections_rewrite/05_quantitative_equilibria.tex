...
consumption, capital, and effective AI production services per unit of
effective labor. These are $g_C-(n+\gamma)$, $g_K-(n+\gamma)$, and
$g_X-(n+\gamma)$, respectively. The third panel connects the simulated path
directly to equation~\eqref{eq:rewrite-transition-share-odds}, since
\begin{equation}
...
AI share changes, conditional on $\sigma$. Levels would obscure the timing of
accumulation because they differ greatly across regimes by the end of the
window; growth rates show directly when the economy accelerates and how it
approaches its terminal regime.

\begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{figures_rewrite/equilibrium_accumulation_growth.pdf}
 \caption{Growth of consumption, capital, and effective AI production services
 ...
 analytical limits for $\sigma=1.50$. All three panels use linear percentage
 scales; Panel C uses its own range.}
