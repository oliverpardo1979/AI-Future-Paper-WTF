...
Panels B and C report the annual growth rates of output per person and the
real wage. Their vertical distance therefore measures the growth wedge in
Proposition~\ref{prop:rewrite-output-wage-wedge}. AI-industry revenue $p_XX/Y$
is distinct from profit and from value added. Gross capital income remains
$\alpha Y$ throughout, so the labor and AI-revenue shares sum to $1-\alpha$.
...
\begin{figure}[H]
 ...
 4,000 model years. Output per unit of effective labor uses a logarithmic
 vertical scale. Growth rates, net interest, and output shares use linear
 percentage scales. All scenarios have the same
