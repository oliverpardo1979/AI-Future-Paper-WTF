...
The slow transition has a direct structural explanation. Rearranging
...
The $\sigma=1.50$ path displays this mechanism. The initial adjustment raises
...
The simulation establishes that such a delay is possible; it does not establish
that its duration is robust to alternative AI calibrations or provide an
