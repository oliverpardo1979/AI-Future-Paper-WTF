...
Figures~\ref{fig:rewrite-labor-bottleneck} and
\ref{fig:rewrite-ai-dominated} report the same six outcomes but separate the
two long-run regimes. This separation prevents the large movements in the
AI-dominated economy from concealing the differences among the three
labor-bottleneck economies. The vertical scales therefore differ across the
two figures and should not be compared by visual distance. Within each figure,
Panels A and B report the annual growth rates of output per person and the real
wage on a common vertical scale. Their distance measures the growth wedge in
Proposition~\ref{prop:rewrite-output-wage-wedge}. Panel C reports the net
interest rate, Panel D the approach of AI efficiency to its frontier, and
Panels E and F the labor-income and AI-revenue shares. AI-industry revenue
$p_XX/Y$ is distinct from profit and from value added. Gross capital income
remains $\alpha Y$ throughout, so the labor and AI-revenue shares sum to
$1-\alpha$.

\begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{figures_rewrite/equilibrium_labor_bottleneck.pdf}
 \caption{Equilibrium transitions in the labor-bottleneck regime. The panels
 compare the admitted trajectories for $\sigma=0.90$, $1$, and $1.10$ over
 4,000 model years. The focused scales reveal differences that are obscured
 when the AI-dominated trajectory is included. Panels A and B use the same
 linear percentage scale. Rates and shares use linear scales, and all
 scenarios have the same initial stocks, frontier, and remaining parameters.}
 \label{fig:rewrite-labor-bottleneck}
\end{figure}

\begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{figures_rewrite/equilibrium_ai_dominated.pdf}
 \caption{Equilibrium transition in the AI-dominated regime. The admitted
 trajectory for $\sigma=1.50$ is compared with the unit-elastic trajectory,
 shown as a gray reference, over 4,000 model years. Horizontal dotted lines
 mark the analytical limits for $\sigma=1.50$. Panels A and B use the same
 linear percentage scale. The vertical scales differ from those in
 Figure~\ref{fig:rewrite-labor-bottleneck}.}
 \label{fig:rewrite-ai-dominated}
\end{figure}
...
\end{equation}
Panels F of Figures~\ref{fig:rewrite-labor-bottleneck} and
\ref{fig:rewrite-ai-dominated} measure the industry's size relative to final
output; Figure~\ref{fig:rewrite-technology-revenue} separates its inference
...
\begin{figure}[H]
 ...
 The scenarios and time window match Figures~\ref{fig:rewrite-labor-bottleneck}
 and~\ref{fig:rewrite-ai-dominated}.
