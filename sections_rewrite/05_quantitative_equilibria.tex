...
\midrule
$\alpha$ & 0.33 & Output elasticity with respect to capital & Standard one-third macro benchmark\\
...
$\eta$ & 0.20 & Research exponent & Illustrative choice; not estimated\\
...
$\overline B$ & $1.10\,\mathcal B(1.50)$ $\simeq170.124$ & Common upper bound on AI efficiency & Ten percent above the threshold for $\sigma=1.50$\\
\bottomrule
\end{tabular}
\end{table}
