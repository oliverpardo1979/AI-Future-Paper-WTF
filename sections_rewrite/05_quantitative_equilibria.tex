...
\begin{rewriteParameterTable}{Main comparison: parameters and initial stocks}{tab:rewrite-parameters}
...
the main comparison starts at ratios between 2.29 and 3.14, below the
...
algorithm for the main comparison. Each subsequent exercise reports its own
configuration in a separate table.
\begin{rewriteParameterTable}{Inputs to the main-comparison algorithm}{tab:rewrite-method-parameters}
\rewriteMainParameterRows
\end{rewriteParameterTable}
...
$\chi$ & 1.4378 & Research productivity & Retained from the main comparison's arbitrary 50-year timing calibration; not refitted here.\\
...
$\omega_X$ & 0.20 & AI production weight & Arbitrary scenario choice retained from the main comparison.\\
$\omega_L$ & 0.80 & Effective-labor weight & Computed as $1-\omega_X$.\\
$\chi$ & 1.4378 & Research productivity & Retained from the main timing calibration; no new timing target.\\
...
\begin{rewriteParameterTable}{Initial financing: main and distant-stock configurations}{tab:rewrite-financing-parameters}
...
$K_0$ & 4 (main);\newline 2.027733654 (distant) & Initial capital & Main: arbitrary intermediate stock. Distant: earlier uncapped BGP stock, used as an illustrative reference.\\
$B_0$ & 17.012402 (main);\newline 0.443670932 (distant) & Initial AI efficiency & Main: arbitrary $10\%$ of the bound. Distant: earlier BGP value, about $0.2608\%$ of the bound; not estimated.\\
