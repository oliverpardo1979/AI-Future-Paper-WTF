...
and monopoly equations. Equation~\eqref{eq:rewrite-rsi-pre-consumption}
gives pre-event consumption. Homogeneity extends these values to a BGP:
...
{replication guide} gives installation instructions. From the repository
root, run:
\begin{quote}
\small
\begin{verbatim}
...
The \href{https://github.com/oliverpardo1979/AI-Future-Paper-WTF/tree/main/numerical_rewrite/rsi_chi_7_5}
{higher-productivity results folder} and
\href{https://github.com/oliverpardo1979/AI-Future-Paper-WTF/tree/main/numerical_rewrite/rsi_chi_1_5}
...
Earlier price- and research-target experiments remain in the repository.
To restore their two subsections and numerical appendix, set the following
switch in \texttt{main\_rewrite.tex}:
\begin{quote}
\small
\verb|\showcalibratedrsiscenariostrue|
\end{quote}
The full-price benchmark and older quantitative section retain
their separate switches, documented in the replication guide. These
switches alter presentation only; they do not modify numerical results.
