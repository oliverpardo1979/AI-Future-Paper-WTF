...
target from the assumed weights and initial productivity.
...
$B_0$ & 17.012402 & Initial AI productivity & $0.10\overline B$; arbitrary assumption, not identified by the no-AI economy.\\
$K_0/Y_0$ & 4.025; 3.620; 3.397; 2.872 & Post-change capital--output ratio & Calculated from the saved paths; 3.30 before the technology switch. The price target does not fit this ratio.\\
...
its capital stock but set latent AI productivity at $10\%$ of the upper bound:
\begin{equation}
...
The initial productivity ratio remains illustrative: it is not identified by
...
compared with $1.4378$ in the illustrative exercise. The price target implies
...
productivity gains without large research expenditure. At $\sigma=1.50$,
...
output at date zero. Combining that initial scale with rapid productivity
