\begin{table}[H]
 \centering
 \caption{Numerical accuracy of the lower research-expenditure calibration}
 ...
 are rounded upward. The unit-elastic initial candidate uses the stricter tolerance
