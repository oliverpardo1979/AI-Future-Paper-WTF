...
\eqref{eq:rewrite-sx}, and \eqref{eq:rewrite-wage} imply that, holding $K$, $A$,
and $L$ fixed,
\begin{align}
...
labor's income share. This result provides a concrete AI-production mechanism
for the broader possibility emphasized by \citet{autorkausik2026}: a falling
labor income share can coexist with a rising real wage. The thresholds $1$ and
$1/\alpha$ are specific to the nested Cobb--Douglas--CES production technology
used here.
...
$\sigma<1/\alpha$ and falls if $\sigma>1/\alpha$. These relationships provide a
