...
\begin{remark}[Why the elasticity of substitution matters]
\label{rem:rewrite-ai-labor}
Equations~\eqref{eq:rewrite-factor-prices} and
\eqref{eq:rewrite-labor-share} show that $\sigma$ governs two distinct
relationships between effective AI production services and labor. Holding $K$
and $L$ fixed, an increase in $X$ raises $w$ if $\sigma<1/\alpha$ but lowers it
if $\sigma>1/\alpha$, while labor's income share rises if $\sigma<1$ and falls
if $\sigma>1$. Equation~\eqref{eq:rewrite-factor-prices} also implies that,
holding $K$ and $w$ fixed, conditional labor demand rises with $X$ if
$\sigma<1/\alpha$ and falls if $\sigma>1/\alpha$. These conditional
relationships, also emphasized by \citet{autorkausik2026} and
\citet{yango2026}, provide a first illustration of why the elasticity of
substitution matters for the effects of AI on labor.
\end{remark}
