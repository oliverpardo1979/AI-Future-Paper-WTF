...
The equilibrium analysis below also maintains $\rho>n$, so discounting
dominates population growth in the household's objective. Assumptions
\ref{ass:rewrite-research-curvature} and
\ref{ass:rewrite-research-concavity} do not by themselves establish the
existence of an equilibrium trajectory. The remaining conditions on the
frontier, initial stocks, and agent optimality must also be checked.
