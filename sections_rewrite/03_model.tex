...
The preceding conditions are necessary for an interior optimum. To state a
sufficient condition, let $X^*(B)$ denote the unique maximizer in
Lemma~\ref{lem:rewrite-monopoly-choice}, holding $K,A,$ and $L$ fixed, and
define the service--efficiency elasticity
\begin{equation}
 \varepsilon_B\equiv
...
\begin{proposition}[Sufficient condition for developer optimality]
