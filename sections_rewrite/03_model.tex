...
I use \emph{compute} to denote the computational resources used to execute the numerical operations required by AI systems \citep{sastryetal2024}. The variables $U$ and $M$ below are rates of compute use rather than stocks of processors or data centers. I measure compute in units such that one unit costs one unit of the final good. Compute is therefore a rival and costly input but not a measure of AI performance.
