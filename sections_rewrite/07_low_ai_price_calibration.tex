...
initial AI efficiency equal to $1\%$ of its upper bound. Research productivity
...
efficiency choices equivalent: $B_0$ affects the initial price and production
allocation, while $\chi$ affects the subsequent improvement in efficiency.
...
the initial efficiency ratio, the upper bound, and the fitted $\chi$ all
