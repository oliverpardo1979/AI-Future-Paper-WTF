...
Singularities, defined as trajectories where variables reach infinite value
in finite time, cannot be equilibria and therefore are not studied in this
paper. The following proposition shows that, when research returns are
