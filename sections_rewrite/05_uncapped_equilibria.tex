...
The proof first uses optimality and transversality to bound consumption and
future research expenditure. It then shows that capital and consumption per
unit of effective labor stay away from zero, while inference and research
expenditure vanish relative to output. The remaining dynamics approach a
Ramsey system, which yields convergence of $K/(AL)$ and $C/(AL)$ to positive
constants. Convergence of consumption growth is therefore a conclusion,
not an assumption. The proposition remains conditional on equilibrium
existence and $B\to\infty$; it does not assume a BGP.
