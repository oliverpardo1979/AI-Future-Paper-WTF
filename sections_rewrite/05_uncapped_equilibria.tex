...
The results differ in scope across substitution regimes. Under complementarity, output-per-worker growth is bounded by the rate of labor-augmenting technological progress, even though there is no upper bound on AI efficiency. At unit elasticity, I give sufficient parameter restrictions for an analytically tractable balanced-growth equilibrium. Under substitution, I show how growth and interest rates increase with the efficiency upper bound and derive a return bound that applies at every date.
...
\subsection{Substitution: growth and the AI-efficiency upper bound}
...
Each deviating plan uses finite research expenditure and keeps AI efficiency
...
it avoids this unbounded-payoff mechanism even without an efficiency cap.
