\begin{rewriteParameterTable}{Slower AI-price decline: parameters and initial stocks}{tab:rewrite-rsi-half-parameters}
$\omega_X$ & 0.10 & AI production weight & Same assumed value as in Table~\ref{tab:rewrite-rsi-parameters}; not fitted to industry size.\\
