...
to models in which accumulable inputs can sustain growth without a vanishing
marginal product \citep{jonesmanuelli1990,rebelo1991}.
...
bottleneck: attainable AI productivity must also be high enough. I derive the
...
upper bound on AI productivity, real-wage growth exceeds the exogenous rate only
...
the AI-productivity threshold determines which regime arises. I do not study
...
when labor is the bottleneck, but rises with attainable AI productivity in the
...
research but summarize the technology that augments both in one AI-productivity
...
AI-productivity stock as a directly observed statistical series.
...
improvements in the productivity of AI that is used in both production and
further research.
...
here with a finite upper bound on AI productivity, real wages grow faster than exogenous labor-augmenting technological
...
AI-dominated regime, higher attainable AI productivity raises both long-run growth
