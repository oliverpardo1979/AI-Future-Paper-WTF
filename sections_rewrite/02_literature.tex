...
I build on the feedback mechanisms studied by \citet{davidsonetal2026} and \citet{jonestonetti2026}, in which technological progress improves research and higher output expands the resources available for further innovation. Both papers endogenize technological progress, but take saving rates and research allocation shares as given in their analyses of aggregate growth. \citet{erdiletal2025gate} instead let a social planner choose investment and compute allocation. I study a decentralized economy: the household chooses consumption and saving to maximize utility, while a monopolistic AI developer chooses research spending to maximize discounted net profit. Saving and investment in AI research are therefore endogenous decisions coordinated through market prices, rather than allocations imposed by assumption or chosen by a social planner.

Monopoly rents finance nonrival knowledge in \citet{romer1990}, and
expected profits direct innovation in \citet{acemoglurestrepo2018} and
\citet{hemousolsen2022}. I apply this private-innovation logic to an AI
developer whose research investment responds to prospective profits from selling
AI services. \citet{liuwan2026} connect AI industry structure to innovation
in a model linking general-purpose AI to specialized applications.
I hold market structure fixed and distinguish the remuneration of physical
capital from the developer's net profit after compute costs. This
distinction allows me to study how the gains from AI are distributed
through wages, capital income, and developer profit.
...
automated. \citet{jones2026future} explains why these bottlenecks can keep
aggregate growth modest even while AI advances rapidly.
In my model, research is already autonomous, but labor can still
...
Higher real wages need not imply a larger labor income share.
\citet{acemoglurestrepo2019} explain how automation can raise productivity
while displacing labor, and how new human tasks can counteract this
displacement. \citet{autorkausik2026} examine how automation can raise
wages while reducing labor's share, and \citet{raymookherjee2022} show
that this share can vanish even as wages rise indefinitely.
\citet{casellimanning2019} establish conditions for technological
progress to raise real wages and identify a further possibility:
technology may increase both economic growth and the interest rate.
Their comparison of steady states, however, does not determine the
resulting wage dynamics. I study this possibility when AI improvement
is driven by private investment in RSI. I characterize when AI
sustains higher long-run growth and interest rates, with real wages
growing faster than in the labor-bottleneck regime but more slowly
than output per worker. Labor's income share then converges to zero.
