...
\else
The following two subsections differ only in research productivity:
$\chi=7.5$ in the higher-productivity scenario and $\chi=1.5$ in the
lower-productivity scenario. These are illustrative choices, not empirical
estimates or normalizations. Research productivity is five times higher
in the first scenario. Each value is held fixed across the four elasticities;
research expenditure and AI-service prices are equilibrium outcomes,
not calibration targets. All other parameters and initial stocks are identical
across the two exercises. The comparison isolates how research productivity
changes the transition without changing the long-run regime.
\fi
