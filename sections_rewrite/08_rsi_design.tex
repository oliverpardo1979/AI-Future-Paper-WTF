...
In this section, I compare the transitional dynamics across the four regimes characterized by Proposition \ref{prop:rewrite-equilibrium-regimes}. I study an unanticipated activation of RSI at date zero. Before date zero, the economy already uses AI production services, but AI efficiency is constant at a level $B_0$. At date zero, the developer gains access to the RSI technology. This ensures a smooth transition for both state variables $B$ and $K$ and prices $w$, $r$ and $p_X$.
