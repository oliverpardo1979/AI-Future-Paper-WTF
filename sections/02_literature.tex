...
Our nested Cobb--Douglas--CES production block yields two thresholds: the labor
share falls when
...
\citet{trammellkorinek2023}. The general separation between the response of the
real wage and that of labor's income share appears in recent automation models,
including \citet{autorkausik2026}. Nor is the general trade-off between
