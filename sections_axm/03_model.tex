...
Given \((K_0,A_0,B_0,N_0)\), a regular interior benchmark equilibrium is an
admissible infinite-horizon path with positive quantities and prices that
satisfies \eqref{eq:axm-canonical-system-benchmark}--\eqref{eq:axm-tvc}, clears
all markets, and solves the household's and developer's optimization problems.
The net interest rate \(r\) and developer payout \(\Pi\) may have either sign.
...
and the two terminal restrictions a candidate path. Proposition
