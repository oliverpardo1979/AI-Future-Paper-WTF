...
\toprule
Parameter & Ramsey--Cass--Koopmans & AI benchmark & Source or justification\\
\midrule
\(\alpha\) & 0.33 & 0.33 & Conventional one-third physical-capital elasticity\\
\(n\) & 0.012 & 0.012 & Illustrative annual population growth; held fixed across scenarios\\
\(\delta\) & 0.05 & 0.05 & Rounded annual depreciation rate, consistent with PWT 11.0 \citep{pwt110}\\
\(\rho\) & 0.04 & 0.04 & Standard annual household discount rate\\
\(\gamma_A\) & 0 & 0 & Isolates growth generated by AI capability\\
\(\omega_L\) & 1 & 0.80 & Follows from \(\omega_L+\omega_X=1\)\\
\(\omega_X\) & 0 & 0.20 & Defines the no-AI and AI scenarios; the AI weight is not directly observed\\
\(\sigma_{XL}\) & Not applicable & 1 & Irrelevant when \(\omega_X=0\); unit-elastic benchmark with AI\\
\(\eta\) & Not applicable & 0.20 & Interior value satisfying the maintained restriction \(\eta<\alpha\)\\
\(\chi\) & Not applicable & 0.01 & Research-productivity normalization governing model time\\
\((K_0,A_0,N_0)\) & (2.944, 1, 1) & (2.944, 1, 1) & Common normalized initial stocks\\
