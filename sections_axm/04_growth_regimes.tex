...
\toprule
Parameter & No AI: \(\omega_X=0\) & AI: \(\omega_X=0.20\) & Source\\
\midrule
\(\alpha\) & \multicolumn{2}{c}{0.33} & Standard macroeconomic calibration: one-third capital share\\
\(n\) & \multicolumn{2}{c}{0.003} & Constant-rate equivalent of the UN world population projection for 2024--2100 \citep{unwpp2024}\\
\(\delta\) & \multicolumn{2}{c}{0.05} & Standard annual calibration, consistent with PWT 11.0 \citep{pwt110}\\
\(\rho\) & \multicolumn{2}{c}{0.04} & Standard annual preference calibration\\
\(\gamma_A\) & \multicolumn{2}{c}{0.01} & Long-run global technical-progress assumption \citep{oecdlongrun2025}\\
...
\(\sigma_{XL}\) & Not applicable & 1 in the benchmark & Varied below and above one in the additional AI scenarios\\
...
\((A_0,N_0)\) & \multicolumn{2}{c}{(1, 1)} & Normalizations common to all scenarios\\
\(B_0\) & Not applicable & 1 & Normalization of initial AI capability\\
\(K_0\) & Scenario-specific & Scenario-specific & Implied by the initial equilibrium after fixing each scenario\\
\bottomrule
\end{tabular}
\end{table}
