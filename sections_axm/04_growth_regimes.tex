...
\(B_0\) & 1 (AI only) & Initial AI capability & Normalization of initial AI capability\\
\(K_0\) & Scenario-specific & Initial physical-capital stock & Implied by the initial equilibrium after fixing each scenario\\
\bottomrule
\end{tabular}
\end{table}
