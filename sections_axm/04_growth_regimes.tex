...
The focused interest-rate scale magnifies this small movement; it does not
represent an explosive increase.
...
scale spanning only 0.004 percentage points. Model time is not a calendar
forecast.}
...
audit. At that horizon, per-capita growth is 1.08637 percent and the net
interest rate is 5.08637 percent, both within 0.00030 percentage points of
their analytical balanced-growth values. The figures retain the first 250
years because that is the economically relevant transition window, not
because the model lacks a long-run limit.
