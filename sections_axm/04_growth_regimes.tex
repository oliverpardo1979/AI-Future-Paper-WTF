...
\end{equation}
The unit resource cost of AI research services is \(1/A\). The relevant
...
condition \(Aw\to\infty\) is essential. The result concerns AI research services
...
capability does not sustain per-capita growth when labor and AI production services are
...
condition, and market clearing for AI production services with \(X=AU\) gives
\begin{equation}
 \frac{U}{Y}=\beta^2,
...
\(A\to\infty\), AI production services dominate the labor--AI CES aggregate. Capital
...
market clearing for AI production services with \(X=AU\), and final production then gives
\begin{equation}
