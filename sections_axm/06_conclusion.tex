...
unit elasticity, the automated-research benchmark admits an equilibrium
...
nearly stable. Analytically, paths near unit elasticity separate from the
unit-elastic benchmark on a time scale of order
\(1/|\sigma_{XL}-1|\); the numerical delay is therefore a structural feature,
not just a solver artifact. This delayed acceleration is closest to the weak-link mechanism
