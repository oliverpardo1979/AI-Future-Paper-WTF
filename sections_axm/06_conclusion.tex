...
also clarifies the uncapped boundary: capped paths can converge to the original
dated equations on a fixed pre-singular interval, while their terminal growth
and interest rates diverge as \(\overline B\to\infty\). Sending the frontier
to infinity therefore cannot silently convert the terminal capped equilibria
into an infinite-horizon equilibrium of the uncapped model.
