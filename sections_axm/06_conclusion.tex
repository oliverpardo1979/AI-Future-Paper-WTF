...
\(\sigma_{XL}>1\) trajectory because the current algorithm has not connected it
to an admissible infinite-horizon equilibrium.
...
the dated equations, a regime-specific tail, sufficient optimality conditions,
and both transversality conditions. These checks do not constitute global
