...
\(\sigma_{XL}>1\) trajectory. A regular bounded-capability continuation
contradicts the developer's costate equation, while the regular AI-dominated
continuation ends at a finite singular date. The proof does not yet exclude
every asymptotically irregular continuation.
