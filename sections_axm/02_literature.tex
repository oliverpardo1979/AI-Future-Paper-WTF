...
prices and market structure. Relative to these papers, our narrower analytical
objective is to determine how equilibrium prices and two factor-substitution
margins govern the feedback, the allocation of compute, and the distribution of
output.
...
exact relabeling of their framework. We use their measurement distinctions; the
...
capital.
\citet{jonestonetti2026} provide a task-based counterpart to our
...
Their simulations also show that automation alone does not determine the
...
tasks assigned to capital; our \(\sigma_{XL}\) aggregates production labor and a
...
make labor asymptotically inessential for aggregate growth. Together with
\citet{acemoglurestrepo2019} and \citet{trammellkorinek2023}, it means that neither
the displacement mechanism nor a vanishing labor share is a new result of our
paper.

The contribution here is to place related mechanisms in a different
